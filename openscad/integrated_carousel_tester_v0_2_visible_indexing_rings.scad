...
Integrated carousel tester v0.2 - visible lower indexing rings preliminary review

Purpose:
- Fuse the lower indexing base and upper circular-vial holder into one
  preliminary tester geometry while preserving visible lower indexing rings.
...
base_floor_height = 2;
lower_ring_reveal_height = 8.8; // lower rings remain visible below this Z height
...
module lower_structural_floor() {
    /*
    Thin lower floor to keep the visible indexing rings mechanically connected
    as one printable tester while preserving the exposed annular geometry.
    */
