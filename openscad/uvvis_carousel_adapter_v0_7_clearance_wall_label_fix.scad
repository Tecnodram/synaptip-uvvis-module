...
Adapter v0.7 - clearance wall and label placement fix

Purpose:
- preserve the v0.6 vial clearance test logic
- size all holder outer walls from the maximum test bore diameter
- move recessed labels away from the vial holders while keeping them nearby
