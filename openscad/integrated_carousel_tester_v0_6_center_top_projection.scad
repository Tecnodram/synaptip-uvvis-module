...
Integrated carousel tester v0.6 - corrected central top-referenced coupling
...
central_coupling_z_min = integrated_platform_height - central_coupling_below_vial_base;
central_coupling_z_max = integrated_platform_height + central_coupling_projection_above_vial_base;
