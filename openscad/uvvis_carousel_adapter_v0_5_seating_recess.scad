...
Adapter v0.5 - seating recess preview

Status:
- Phase 0 / Phase 1 only
- Not validated for fit, safety, or compatibility
- Adds a provisional internal seating recess for circular vials
- Keeps the light-window reference tied to the seated vial base
*/
    ...
    difference() {
        ...
        translate([0, 0, holder_height_mm - top_lead_in_depth_mm])
            cylinder(
                ...
                d1 = holder_inner_diameter_mm,
                d2 = holder_inner_diameter_mm + top_lead_in_extra_diameter_mm
            );
