...
Integrated carousel tester v0.8.1 - ring height reference fix from v0.3 base
...
- Freeze review helpers off for STL export and exploratory print testing.`r`n- Preserve v0.8 geometry while correcting only the upper cap height reference so lower ring heights remain visible like indexing_base_v0_3_print_ready.
